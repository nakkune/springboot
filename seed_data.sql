...
VALUES 
    ('8f2e4c6a-4d2a-4a62-8149-1e35d27bcf1a', 'a3b2c1d0-e9f8-7a6b-5c4d-3e2f1a0b9c8d', 'owner'),
    ('8f2e4c6a-4d2a-4a62-8149-1e35d27bcf1a', 'd1111111-e9f8-7a6b-5c4d-3e2f1a0b9c8d', 'member'),
    ('8f2e4c6a-4d2a-4a62-8149-1e35d27bcf1a', 'd2222222-e9f8-7a6b-5c4d-3e2f1a0b9c8d', 'member'),
    ('8f2e4c6a-4d2a-4a62-8149-1e35d27bcf1a', 'd3333333-e9f8-7a6b-5c4d-3e2f1a0b9c8d', 'member')
ON CONFLICT (workspace_id, user_id) DO NOTHING;

-- 2. 보드 컬럼 추가 (status, person, date, tags)
DO $$
DECLARE
...
BEGIN
    ...
    INSERT INTO board_columns (id, board_id, name, column_type, settings, position) VALUES
        ...
        (v_col_end, v_board_id, '마감일', 'date', '{}', 4),
        (v_col_tags, v_board_id, '태그', 'tags', '{}', 5);
